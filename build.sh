...
case "$OS" in
    Linux*)
        ...
        ../Godot_v4.5.1-stable_mono_linux_x86_64/Godot_v4.5.1-stable_mono_linux.x86_64 --export-pack "Windows Desktop" dist/FirstMod.pck --headless
        cp FirstMod.json dist/FirstMod.json
        ;;
    Darwin*)
